...
output_dir = "/home/quiquevb/Cells2Spine/Cells2Spine/Outputs/spatial/DEA_dorsal/ClusterProfilerEnrichment"
...
go_enrich_up_bp_df.to_csv(f"{output_dir}/go_enrichment_upregulated_BP.csv", index=False)
go_enrich_up_cc_df.to_csv(f"{output_dir}/go_enrichment_upregulated_CC.csv", index=False)
go_enrich_up_mf_df.to_csv(f"{output_dir}/go_enrichment_upregulated_MF.csv", index=False)

go_enrich_down_bp_df.to_csv(f"{output_dir}/go_enrichment_downregulated_BP.csv", index=False)
go_enrich_down_cc_df.to_csv(f"{output_dir}/go_enrichment_downregulated_CC.csv", index=False)
go_enrich_down_mf_df.to_csv(f"{output_dir}/go_enrichment_downregulated_MF.csv", index=False)